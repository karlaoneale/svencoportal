...
templates_that_req_actions <- c("task_complete", "task_time", "task_time_reminder", "request_payment_without_quote", "new_invoice_approval_2", "quote_approval",
