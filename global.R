...
templates_that_req_actions <- c("task_complete", "task_time", "request_payemt_without_quote", "invoice_approval", "quote_approval",
                            "request_quote_pmt", "all_tasks_completed", "start_invoice")